...
final class ScreenshotTests: XCTestCase {
    ...
    func testGenerateScreenshots() throws {
        ...
        for (w, h) in sizes {
            ...
            save(VillageShot(w: w, h: h), w: w, h: h, name: "02-village-\(label)")
            save(StatsShot(w: w, h: h), w: w, h: h,   name: "03-stats-\(label)")
            save(GridShot(w: w, h: h), w: w, h: h,    name: "04-grid-\(label)")
        }
    }
